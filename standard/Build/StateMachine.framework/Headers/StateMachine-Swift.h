...
SWIFT_CLASS("_TtC12StateMachine9FSMParser")
@interface FSMParser : NSObject <NSXMLParserDelegate>

/// Constructor.
- (SWIFT_NULLABILITY(nonnull) instancetype)initWithFsm:(NSString * __nonnull)fsm OBJC_DESIGNATED_INITIALIZER;
